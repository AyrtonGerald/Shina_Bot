...
┃ ${rpgg.emoticon('money')} *ShinaCoins: » ${money}*
...
_2.Top ShinaCoins_ *${usersmoney.indexOf(m.sender) + 1}* _de_ *${usersmoney.length}*
...
*│ ⛏️🐱 Minar ShinaCoins » ${new Date - user.lastcoins < 600000 ? '❌' : '✅'}*
