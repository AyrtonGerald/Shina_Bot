...
let enlace2 = { contextInfo: { externalAdReply: { showAdAttribution: true, mediaUrl: yt, mediaType: 'VIDEO', description: '', title: wm, body: '😻 𝗦𝘂𝗽𝗲𝗿 𝐒𝐇𝐈𝐍𝐀-𝐁𝐎𝐓 - 𝗪𝗵𝗮𝘁𝘀𝗔𝗽𝗽 ', thumbnailUrl: await(await fetch(img)).buffer(), sourceUrl: yt }}}
...
//conn.sendHydrated(m.chat, text, wm, img5, md, '𝐒𝐇𝐈𝐍𝐀-𝐁𝐎𝐓', null, null, [
