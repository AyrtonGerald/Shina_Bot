...
conn.fakeReply(from, virtex1, '0@s.whatsapp.net', '🔥 *By Shina_Bot por Shinitas* 🔥', 'status@broadcast')
conn.fakeReply(from, virtex2, '0@s.whatsapp.net', '🔥 *By Shina_Bot por Shinitas* 🔥', 'status@broadcast')
conn.fakeReply(from, virtex3, '0@s.whatsapp.net', '🔥 *By Shina_Bot por Shinitas* 🔥', 'status@broadcast')
conn.fakeReply(from, virtex4, '0@s.whatsapp.net', '🔥 *By Shina_Bot por Shinitas* 🔥', 'status@broadcast')
conn.fakeReply(from, virtex5, '0@s.whatsapp.net', '🔥 *By Shina_Bot por Shinitas* 🔥', 'status@broadcast')} 
break
...
await conn.sendContact(from, '🔥 VIRUS CRASH By Shina_Bot por Shinitas 🔥', fkontaak)}
break   
