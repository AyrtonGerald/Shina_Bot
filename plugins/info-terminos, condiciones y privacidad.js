...
*https://www.paypal.me/DoraimonPro*


*~ Muchas Gracias Por tomarte el tiempo en informate sobre GataBot*
`.trim()
conn.sendHydrated(m.chat, Terminos,  `${wm}\nEstamos de acuerdo en Hacer Colaboraciones con Personas Comprometidas, manteniendo el Respeto Puedes Contactar si ese es el caso a esta Cuenta Oficial | Soon`, pp, 'Soon', '𝐒𝐇𝐈𝐍𝐀-𝐁𝐎𝐓', null, null, [
