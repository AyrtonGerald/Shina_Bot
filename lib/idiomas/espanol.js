...
const smsLista1 = () => { return `🌟 INFORMACIÓN DE SHINABOT 🌟`}
...
const smsLista7 = () => { return `🐈 INSTALAR SHINABOT 🐈`}
...
const eGataCoins = () => { return '🐱 SHINACoins' }
const eGataTickers = () => { return '🎫 Shina Tickers' } 
...
const smsModP2 = () => { return `Habilitar función para que todos puedan usar ShinaBot`}
const smsModAd1 = () => { return `🛂 MODO ADMIN`}
const smsModAd2 = () => { return `Solo los Admins podrán usar ShinaBot en Grupos`}
...
const smsJBInfo2 = () => { return `💖 *La función es estable, sí presenta algún incoveniente Comuníquese al correo: centershinabot@gmail.com*\n💝 *Puede hacer una Donación voluntaria por PayPal: ${global.paypal}*\n\n*Muchas Gracias por el apoyo a ${global.packname}*`}
